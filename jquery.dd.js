...
(function ($) {
	...
	$.fn.dd = function (options, callback) {
		var settings;
		// this just adds more flexibility in how it's used,
		// if you just send it a call back it'll still work
		// as expected.
		...
		return this.each(function () {
			var elem, selected, main_div, option_list, input, attrs, attr, button;
